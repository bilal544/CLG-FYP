...
<main class="max-w-6xl py-7 px-4 mx-auto">
  <form id="js-ai-essay-writer"
    ...
    <div class="flex items-center justify-between gap-2.5 mb-3">
      ...
      <button type="button" id="js-sample-text" aria-label="try-sample-text"
        class="py-1 px-2.5 block text-sm/6 hover:bg-gray-100 transition-all ease-in duration-150 cursor-pointer border border-gray-300 rounded text-gray-600 font-medium">
        Try Sample Topic
      </button>
    </div>
    ...
    <div class="w-full mx-auto flex sm:flex-row flex-col sm:items-center items-start gap-2.5 justify-between">
      ...
      <input type="submit" id="submit" value="Generate Essay"
        class="max-w-max w-full bg-[#131313] focus:ring-0 focus:outline-0 focus:border-0 hover:bg-[#131313]/85 transition-all ease-in duration-150 cursor-pointer rounded text-white py-2 px-3 text-sm/5 font-medium">
    </div>
  </form>
  ...
  <div
    ...
    <div
      ...
      <p class="text-lg/5 font-semibold text-[#131313]">
        Essay Result
      </p>
