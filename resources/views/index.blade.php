    ...
    <div class="container mx-auto">
        <div
            ...
            <div class="input-box w-full border-r flex flex-col border-gray-300 flex-1 min-h-[400px] relative">
                <div class="hidden js-file-loader flex-col gap-2 items-center justify-center min-h-[385px]">
                ...
                <div class="px-4 py-5 w-full flex-grow">
                    <textarea name="input-text" id="js-input-text"
                        ...
                        spellcheck="false"
                        class="min-h-[350px] thin-scrollbar w-full resize-none border-0 ring-0 outline-0 focus:outline-0 focus:border-0 focus:ring-0"></textarea>
                </div>
                ...
                <div id="js-btn-group"
                    ...
                    <label for="file"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                            stroke="currentColor"
                            class="size-8 text-gray-600 group-hover:text-[#007aff] transition-all ease-in duration-150">
                            <path stroke-linecap="round" stroke-linejoin="round"
                                d="M12 16.5V9.75m0 0 3 3m-3-3-3 3M6.75 19.5a4.5 4.5 0 0 1-1.41-8.775 5.25 5.25 0 0 1 10.233-2.33 3 3 0 0 1 3.758 3.848A3.752 3.752 0 0 1 18 19.5H6.75Z" />
                        </svg>
                        <h3
                            class="text-base/6 text-gray-600 group-hover:text-[#007aff] transition-all ease-in duration-150 font-semibold">
                            Upload File
                        </h3>
                    </label>
                    {{-- upload file end --}}
                    <div class="flex items-center gap-2">
                        <button type="button" id="js-sample-text" aria-label="try-sample-text"
                            class="py-2 px-4 hover:bg-gray-100 hover:text-[#007aff] transition-all ease-in duration-150 cursor-pointer border border-gray-300 rounded-full text-gray-600 font-medium">
                            Try Sample Text
                        </button>
                ...
                <div
                    ...
                    <button type="button"
                        class="js-text-summarize hover:bg-[#007aff]/90 transition-all ease-in duration-150 text-white text-base/5 font-medium cursor-pointer bg-[#007aff] py-2 px-4 rounded-full border-0 ring-0 outline-0">
                        Summarize
                    </button>
                </div>
            </div>
            ...
            <div class="output-box h-full flex-1 lg:block hidden">
                ...
                <div class="px-4 py-5 w-full flex-grow js-result-show">
                    <div name="result-text" id="js-result-text" data-placeholder="Result will be display here..."
                        spellcheck="false" readonly
                        class="min-h-[350px] thin-scrollbar w-full resize-none border-0 ring-0 outline-0 focus:outline-0 focus:border-0 focus:ring-0"></div>
                </div>
                <div
